                ...
                <div class="col-md-10 m-b-20">
                    <div class="form-floating">
                        ...
                        <div class="p-l-10 m-t-10">
                            <small>Other Media (Each file max 2MB | png, jpg, jpeg, gif)</small><br>

                            <input type="file" multiple class="form-control" id="listingMedia" accept=".png,.jpg,.jpeg,.gif" @change="processUpload">
