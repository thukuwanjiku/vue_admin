...
function viewListing(listing){
    if(!checkHasPermission('investment_hub.reported_listings.view')) return;
...
<template>
        ...
        <div class="table-responsive m-t-10" v-if="checkHasPermission('investment_hub.reported_listings.view')">
            <table class="table">
                ...
                <tr v-if="listings.length" v-for="(listing, index) in listings"
                    ...
                    <td><el-button :disabled="!checkHasPermission('investment_hub.reported_listings.view')" @click="viewListing(listing)" type="primary" size="small" plain>View</el-button></td>
                </tr>
    ...
    <el-dialog
        ...
        <div class="row" style="max-height:95vh;overflow-y:scroll;" v-loading="isModalLoading">
            ...
            <div v-if="checkHasPermission('investment_hub.listings.archive')" class="m-t-20 m-b-20 d-flex justify-content-end">
